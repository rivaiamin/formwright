...
export const TEMPLATES: FormTemplate[] = [
  ...
  },
  {
    ...
    schema: {
      ...
      completedHtml: { default: 'Thanks — we will get back to you shortly.' },
      pages: [
        {
          name: 'page1',
          elements: [
            { type: 'text', name: 'full_name', title: { default: 'Your name' }, isRequired: true },
            {
              type: 'text',
              name: 'email',
            ...
            { type: 'text', name: 'subject', title: { default: 'Subject' } },
            { type: 'comment', name: 'message', title: { default: 'Message' }, isRequired: true, rows: 5 },
          ],
        },
      ],
    },
          ...
          elements: [
            {
              type: 'rating',
              name: 'nps',
              title: { default: 'How likely are you to recommend us?' },
              rateMax: 10,
              isRequired: true,
            },
            {
              type: 'radiogroup',
              name: 'satisfaction',
              title: { default: 'Overall, how satisfied are you?' },
              choices: [
                { value: 'very_satisfied', text: { default: 'Very satisfied' } },
                { value: 'satisfied', text: { default: 'Satisfied' } },
                { value: 'neutral', text: { default: 'Neutral' } },
                { value: 'dissatisfied', text: { default: 'Dissatisfied' } },
              ],
            },
            { type: 'comment', name: 'comments', title: { default: 'Anything we could improve?' } },
          ],
        },
      ],
    },
          ...
          elements: [
            {
              type: 'radiogroup',
              name: 'capital',
              title: { default: 'What is the capital of France?' },
              choices: [
                { value: 'paris', text: { default: 'Paris' } },
                { value: 'lyon', text: { default: 'Lyon' } },
                { value: 'marseille', text: { default: 'Marseille' } },
              ],
              correctAnswer: 'paris',
              points: 1,
            },
            {
              ...
              choices: [
                ...
                { value: 'yellow', text: { default: 'Yellow' } },
              ],
      ...
      pages: [
        {
          ...
          elements: [
            ...
            { type: 'text', name: 'email', title: { default: 'Email' }, isRequired: true, validators: [{ type: 'email' }] },
            { type: 'text', name: 'company', title: { default: 'Company' } },
          ],
        },
        {
          name: 'preferences',
          ...
          elements: [
            {
              type: 'boolean',
              name: 'dietary_needs',
              title: { default: 'Do you have any dietary requirements?' },
            },
            {
              type: 'comment',
