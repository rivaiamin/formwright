...
<section class="hist" data-testid="history-panel">
  <div class="hist__head">
    ...
    <span class="hist__hint">Restoring loads the version into the builder — Save to keep it, Undo to back out.</span>
  </div>
  ...
  {:else if rows.length === 0}
    <p class="hist__empty" data-testid="history-empty">No saved versions yet. Save the form to create one.</p>
  {:else}
    <ul class="hist__list">
