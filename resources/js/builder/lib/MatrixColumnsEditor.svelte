...
<div class="mcol">
    ...
    <div class="mcol__row" data-column={str(column.name)}>
      <div class="mcol__top">
        <input
          ...
          value={localizedValue(column.title as never, store.editingLocale)}
          oninput={(e) => store.setListItemLocalized(element.name, 'columns', i, 'title', e.currentTarget.value)}
        />
        <button type="button" class="mcol__del" aria-label="Remove column" onclick={() => store.removeListItem(element.name, 'columns', i)}>×</button>
      </div>
      <div class="mcol__meta">
        <input
          ...
          oninput={(e) => store.setListItemProp(element.name, 'columns', i, 'name', e.currentTarget.value)}
        />
        <select
          class="mcol__type"
          aria-label="Cell type"
          value={str(column.cellType, 'dropdown')}
          onchange={(e) => store.setListItemProp(element.name, 'columns', i, 'cellType', e.currentTarget.value)}
        >
  ...
  <button type="button" class="mcol__add" data-testid="matrix-column-add" onclick={add}>+ Column</button>
</div>
