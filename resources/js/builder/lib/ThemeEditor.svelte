<script lang="ts">
    ...
    let accent = $derived(
        store.themeVar('--sjs-primary-backcolor') || DEFAULT_ACCENT,
    );
    let palette = $derived(
        store.themeProp('colorPalette') === 'dark' ? 'dark' : 'light',
    );
    ...
    let pageBg = $derived(
        store.themeVar('--sjs-general-backcolor-dim') || DEFAULT_PAGE_BG,
    );
    let surfaceBg = $derived(
        store.themeVar('--sjs-general-backcolor') || DEFAULT_SURFACE_BG,
    );
    let customBg = $derived(
        store.themeVar('--sjs-general-backcolor-dim') !== '' ||
            store.themeVar('--sjs-general-backcolor') !== '',
    );
...
<div class="theme">
    ...
    <div class="theme__grid">
        <div class="field">
            ...
            <div class="theme__seg">
                <button
                    type="button"
                    class:on={palette === 'light'}
                    onclick={() => store.setThemeProp('colorPalette', '')}
                    >Light</button
                >
                <button
                    type="button"
                    data-testid="theme-dark"
                    class:on={palette === 'dark'}
                    onclick={() => store.setThemeProp('colorPalette', 'dark')}
                    >Dark</button
                >
            </div>
        </div>
        ...
        <div class="field">
            ...
            <select
                ...
                value={radius}
                onchange={(e) =>
                    pickVar('--sjs-corner-radius', e.currentTarget.value)}
            >
        ...
        <div class="field">
            ...
            <select
                ...
                value={baseUnit}
                onchange={(e) =>
                    pickVar('--sjs-base-unit', e.currentTarget.value)}
            >
        ...
        <div class="field">
            <label class="field__label" for="theme-page-bg"
                >Page background</label
            >
            <input
                id="theme-page-bg"
                type="color"
                data-testid="theme-page-bg"
                value={pageBg}
        ...
        <div class="field">
            <label class="field__label" for="theme-surface-bg"
                >Question background</label
            >
            <input
                id="theme-surface-bg"
                type="color"
                data-testid="theme-surface-bg"
                value={surfaceBg}
                oninput={(e) => setSurfaceBackground(e.currentTarget.value)}
            />
        </div>
        ...
        <div class="field">
            ...
            <select
                ...
                value={fontFamily}
                onchange={(e) =>
                    pickVar('--sjs-font-family', e.currentTarget.value)}
            >
    ...
    <button
        ...
        onclick={() => store.resetTheme()}>Reset to default theme</button
    >
</div>
