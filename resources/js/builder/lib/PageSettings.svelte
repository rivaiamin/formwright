...
<aside class="panel" aria-label="Page settings">
    ...
    {:else}
        ...
        <p class="panel__help">
            The page is skipped but its fields stay in the schema.
        </p>

        <div class="field">
            <label class="field__label" for="page-visibleif"
                >Show this page only if…</label
            >
            <textarea
                id="page-visibleif"
            ...
            ></textarea>
            <p class="panel__help">
                A SurveyJS expression referencing other fields, e.g. <code
                    >{'{role}'} = 'admin'</code
                >.
            </p>
        </div>
        ...
        <div class="field">
            ...
            <select
                id="page-order"
                value={typeof page.questionsOrder === 'string'
                    ? page.questionsOrder
                    : 'default'}
                onchange={(e) =>
                    store.setPageProp(
        ...
        <div class="field">
            ...
            <select
                ...
                value={typeof page.navigationButtonsVisibility === 'string'
                    ? page.navigationButtonsVisibility
                    : 'inherit'}
                onchange={(e) =>
                    store.setPageProp(
                        page.name,
        ...
        <LocalizedInput
            {store}
            target={page}
            propKey="navigationTitle"
            label="Menu title (table of contents)"
            onset={setLoc('navigationTitle')}
        />
        <LocalizedInput
            {store}
            target={page}
            propKey="navigationDescription"
            label="Menu description"
            onset={setLoc('navigationDescription')}
        />
        ...
        {#if showAdvanced}
            <div class="field">
                ...
                <input
                    ...
                    value={page.name}
                    onchange={(e) =>
                        store.renamePage(page.name, e.currentTarget.value)}
                />
            </div>
            <p class="panel__warn">
                Warning: renaming a page can break logic that references it.
            </p>
            ...
            <div class="field">
                <label class="field__label" for="page-enableif"
                    >Enable this page only if…</label
                >
                <textarea
                    id="page-enableif"
                    rows="2"
                    placeholder="{'{plan}'} = 'pro'"
                    value={typeof page.enableIf === 'string'
                        ? page.enableIf
                        : ''}
                    oninput={(e) =>
                        store.setPageProp(
            ...
            <div class="field">
                <label class="field__label" for="page-titleloc"
                    >Question title position</label
                >
                <select
                    id="page-titleloc"
                    data-testid="page-title-location"
                    value={typeof page.questionTitleLocation === 'string'
                        ? page.questionTitleLocation
                        : 'default'}
                    onchange={(e) =>
                        store.setPageProp(
                            page.name,
            ...
            <div class="field">
                <label class="field__label" for="page-maxwidth"
                    >Maximum width</label
                >
                <input
                    id="page-maxwidth"
                    ...
                    value={typeof page.maxWidth === 'string'
                        ? page.maxWidth
                        : ''}
                    oninput={(e) =>
                        store.setPageProp(
            ...
            <div class="field">
                <label class="field__label" for="page-timelimit"
                ...
                <input
                    ...
                    type="number"
                    min="0"
                    value={typeof page.maxTimeToFinish === 'number'
                        ? String(page.maxTimeToFinish)
                        : ''}
                    oninput={(e) =>
                        store.setPageProp(
                            page.name,
